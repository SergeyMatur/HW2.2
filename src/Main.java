...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        HafflepuffStudent cedric = generateHafflepuffStudent("Седрик Диггори");
    ...
    private static HafflepuffStudent generateHafflepuffStudent(String name) {
        return new HafflepuffStudent(
                name,
                RANDOM.nextInt(100),
                RANDOM.nextInt(100),
                RANDOM.nextInt(100),
